-- Active: 1716326277789@@127.0.0.1@1433@master
-- SETUP
USE master;

DROP DATABASE IF EXISTS "REVISTA_MATEO_CARRIQUI_321268_N2F";

-- CREAR Y SELECCIONAR DB
CREATE DATABASE "REVISTA_MATEO_CARRIQUI_321268_N2F";
...
CREATE TABLE Partido (
    ...
    CONSTRAINT PK_Partido PRIMARY KEY (codEquipo_local, codEquipo_visita, fecha),
